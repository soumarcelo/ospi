...
public class CreateIndividualPaymentAccountUseCase(
...
{
    public async Task<IResult<Guid>> Execute(Guid userId, CreateIndividualPaymentAccountDTO dto)
    {
        if (dto.Document == IndividualDocument.Invalid)
        {
